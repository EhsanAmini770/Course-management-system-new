...
def lesson_details(request, id):
    ...
    return render(request, 'course_management/student/lesson_details.html', {'course': course, 'course_user': course_user})
...
def personal_login(request):
    ...
    return render(request, 'course_management/user_login.html', {'user_error': user_error , 'username':username})
